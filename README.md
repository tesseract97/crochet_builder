This is an image processing project that will take an image and return a crochet pattern where each pixel is a color in order to make colorwork easier. 
